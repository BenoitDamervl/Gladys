...
const DEVICE_SUBSERVICE_LIST = createList(DEVICE_SUBSERVICE);
...
module.exports.DEVICE_SUBSERVICE = DEVICE_SUBSERVICE;
module.exports.DEVICE_SUBSERVICE_LIST = DEVICE_SUBSERVICE_LIST;
